...
let nowlocation = decodeURIComponent(location.href.substring(0, location.href.lastIndexOf('/')));
let nowbrowser = "";
let nowsystrem = "";
let nowversion = "";
...
const _begin = () => {
    console.log("#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~BEGIN~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#")
    console.log("         学习内容：" + document.title)
    console.log("         调试时间：" + now)
    console.log("         文件所处位置：" + nowlocation)
    console.log("         当前浏览器为：" + nowbrowser + "  版本为：" + nowsystrem + "  所处操作系统为：" + nowversion)
    console.log("#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~BEGIN~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#~#\n\n\n")
}
...
(function ($) {
    ...
    BrowserMatch.init();
    nowbrowser = BrowserMatch.browser;
    nowsystrem = BrowserMatch.version;
    nowversion = BrowserMatch.OS;
